...
@Component
@ConditionalOnProperty(prefix = "content.messaging.kafka", name = "enabled", havingValue = "true")
public class CacheInvalidationListener {
    ...
    @KafkaListener(topics = "${cache.invalidation.topic:cache-invalidation-events}", groupId = "content-cache-invalidation")
