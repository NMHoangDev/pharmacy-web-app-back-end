...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, String> {
    ...
    long deleteByAppointmentIdAndIdIn(String appointmentId, Collection<String> ids);

    // For cursor-based pagination (simple version using createdAt)
    // List<ChatMessage>
    // findByAppointmentIdAndCreatedAtBeforeOrderByCreatedAtDesc(String
    // appointmentId, Timestamp before, Pageable pageable);
}
